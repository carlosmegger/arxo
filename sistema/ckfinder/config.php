...
if($_SERVER['HTTPS'] == 'on'){
	$http = 'https://'.$_SERVER["HTTP_HOST"].'/dataprisma/';
} else {
	$http = 'http://'.$_SERVER["HTTP_HOST"].'/';
}
if($_SERVER['HTTP_HOST'] == 'clientes.dataprisma' || $_SERVER['HTTP_HOST'] == 'dataprisma.no-ip.info' || $_SERVER['HTTP_HOST'] == 'servidor.dataprisma'){
	$http .= '/arxo/';
} else {
	$http .= '';
}
...
#$baseUrl = $http.'images/';
#$baseUrl = '/novo/images/';
$baseUrl = '/img/noticias/';

$baseUrl_noticias = '/img/noticias/';
#$baseUrl_noticias = '/arxo/sites/02/site/img/noticias/';
...
*/
$baseDir = resolveUrl($baseUrl);
$baseDir_noticias = resolveUrl($baseUrl_noticias);

#echo $baseDir_noticias;
#die;
