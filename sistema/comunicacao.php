...
<div id="conteudo">
	...
	if($acao == ''){
		...
		$query = mysql_query("select * from ".COMUNICACAO." order by idioma asc");
	...
	elseif($acao == 'editar'){
		...
		if(!$_POST){
			...
			include('form/form-comunicacao.php');
			echo '</div>';
		} else {
			...
			atualizar(COMUNICACAO,$dados,"idioma = '".$idioma."'");
