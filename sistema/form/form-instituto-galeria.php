...
if($acao == 'editar'){
	if(is_numeric($id)){
		$sql = selecionar("",INSTITUTO_GAL,"where idimg = ".$id);
...
?>
<form name="form-instituto-gal" id="form-instituto-gal" class="<?=$acao?>" method="post" enctype="multipart/form-data" action="<?=($acao == 'adicionar') ? '?acao=adicionar' : '' ?>">
