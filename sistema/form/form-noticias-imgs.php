...
if($acao == 'editar'){
	if(is_numeric($id)){
		$sql = selecionar("",NOTICIAS_IMGS,"where idimg = ".$id);
...
?>
<form name="form-noticias-imgs" id="form-noticias-imgs" class="<?=$acao?>" method="post" enctype="multipart/form-data" action="<?=($acao == 'adicionar') ? '?acao=adicionar' : '' ?>">
