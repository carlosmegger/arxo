...
if($acao == 'editar'){
	if(is_numeric($id)){
		$sql = selecionar("",POPUP,"where idpopup = ".$id);
	...
	$url = 'http://';
	$ativo = 'S';
	$posicao = proxPosicao(POPUP,'asc');
}
?>
<form name="form-popup" id="form-popup" method="post" enctype="multipart/form-data" action="">
	...
	<span>
		...
		<div class="small">(Tamanho ideal: 800px de largura x 500px de altura)</div>
	</span>
	<span>
