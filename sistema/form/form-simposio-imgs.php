...
if($acao == 'editar'){
	if(is_numeric($id)){
		$sql = selecionar("",SIMPOSIO_IMGS,"where idimg = ".$id);
...
?>
<form name="form-simposio-imgs" id="form-simposio-imgs" class="<?=$acao?>" method="post" enctype="multipart/form-data" action="<?=($acao == 'adicionar') ? '?acao=adicionar' : '' ?>">
