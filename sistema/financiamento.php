...
<div id="conteudo">
	...
	if($acao == ''){
		...
		$query = mysql_query("select * from ".FINANCIAMENTO." order by idioma asc");

		if(mysql_num_rows($query) == 0){ ?>
        	<p>N&atilde;o há itens cadastrados!</p>
		<? } else { ?>
			<div class="listagem">
            	<div class="cabecalho caixa-instituto">
		...
		if (!$_POST){
			...
			include('form/form-financiamento.php');
			echo '</div>';
		} else {
			...
			atualizar(FINANCIAMENTO,$dados,"idioma = '".$idioma."'");
