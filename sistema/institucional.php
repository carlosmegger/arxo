...
$path_temp = '../img/institucional/temp/';
$path_p = '../img/institucional/p/';
$path = '../img/institucional/';
...
<div id="conteudo">
	...
	if($acao == ''){
		...
		$query = mysql_query("select * from ".INSTITUCIONAL." order by idioma asc");
	...
	elseif($acao == 'editar'){
		...
		if(!$_POST){
			...
			include('form/form-institucional.php');
			echo '</div>';
		} else {
			...
			atualizar(INSTITUCIONAL,$dados,"idioma = '".$idioma."'");
			...
			if($imagem['name'] != ''){
				...
				atualizar(INSTITUCIONAL,"imagem = '".$img."'","idioma = '".$idioma."'");
	...
	elseif($acao == 'remover-img'){
		if($idioma != ''){
			...
			$img = mysql_fetch_assoc(mysql_query("select * from ".INSTITUCIONAL." where idioma = '".$idioma."'"));
			...
			atualizar(INSTITUCIONAL,"imagem = null","idioma = '".$idioma."'");
		}
