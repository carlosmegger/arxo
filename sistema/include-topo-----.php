	...
	<div id="menu">
		<div class="links">
			...
			<? if(in_array('instituto',$_permissoes) || in_array('instituto-galeria',$_permissoes)){ ?>
                <div>
                    <p>Instituto Arxo:</p>
                    <? if(in_array('instituto',$_permissoes)){ ?><span class="instituto"><a href="instituto.php" <?=($page == 'instituto') ? 'class="ativo"' : '' ?>>Instituto</a></span><? } ?>
                    <? if(in_array('instituto-galeria',$_permissoes)){ ?><span class="instituto-galeria"><a href="instituto-galeria.php" <?=($page == 'instituto-galeria') ? 'class="ativo"' : '' ?>>Instituto Galeria</a></span><? } ?>
                </div>
			<? } ?>
