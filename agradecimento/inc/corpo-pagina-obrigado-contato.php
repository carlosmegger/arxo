	...
	<div id="contrato">
		<div class="row text-center">
			...
			<div class="col-md-8 col-md-offset-2 text-center">
				<p>Em breve um dos nossos consultores de marketing digital responderá sua solicitação.</p>
			</div>
		</div>
	</div>
</div><!-- /.container -->

<!-- Google Code for LP AdWords - Contatos Conversion Page -->
...
var google_conversion_label = "c2ExCMT57lYQ7p66zgM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/969838446/?label=c2ExCMT57lYQ7p66zgM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
